...
public class OrderListCompletedFragment extends ListFragment {
    private static final String TAG = makeLogTag(OrderListCompletedFragment.class);
    ...
    public void refreshData(){
        ...
        mItem = orderDBAdapter.getAllCompletedOrders();
    ...
    public void updateList(String text)
    {
        ...
        {
            mItem = orderDBAdapter.getAllCompletedOrdersBySearch(text);
        }
