...
public class CheckoutFragment extends ListFragment {
    private static final String TAG = makeLogTag(CheckoutFragment.class);

    private CheckoutFragment.Callback callback = checkoutCallback;
     ...
     */
    private static final CheckoutFragment.Callback checkoutCallback = new CheckoutFragment.Callback() {
        @Override
    ...
    public void refreshData(){
        mItem = ((CheckoutActivity)getActivity()).getListOrderItems();

        setListAdapter(new CheckoutFragment.MyListAdapter());
    }
